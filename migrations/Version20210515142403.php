 ...
 */
final class Version20210515142403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, manga_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, small_description LONGTEXT NOT NULL, full_description LONGTEXT NOT NULL, name_character VARCHAR(255) NOT NULL, price VARCHAR(120) NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, is_published TINYINT(1) NOT NULL, material VARCHAR(120) NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_D34A04AD7B6461 (manga_id), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
